...
;; [[file:../dotfiles/doom.d/config.org::*Language Server Protocol][Language Server Protocol:2]]
...
(add-hook! '(json-mode typescript-tsx-mode typescript-mode rjsx-mode js2-mode js-mode) #'prettier-mode)
;; Prettier:2 ends here

;; [[file:../dotfiles/doom.d/config.org::*Prettier][Prettier:3]]
(use-package! prettier
  :config
  (setq prettier-enabled-parsers '(babel-flow babel-ts json json5 json-stringify lua markdown postgresql python scss typescript yaml)))
;; Prettier:3 ends here
...
(use-package! corfu
  ...
  :config
  (setq corfu-cycle t)
  ;; Disable autocomplete, otherwise press TAB to try completion candidates
  (setq corfu-auto  nil)
