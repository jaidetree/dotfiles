...
export PATH=/usr/local/share/npm/bin/:/usr/local:/usr/local/bin:/Users/jay/Scripts:/usr/bin:/bin:/usr/sbin:/sbin:/usr/local/git/bin:/usr/local/share/npm/bin/:/Users/jay/Scripts:$PATH
