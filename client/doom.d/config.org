...
*** Theme
#+begin_src emacs-lisp
(setq doom-theme (if (controlling-tty-p) 'doom-Iosvkem 'doom-one))
#+END_SRC
...
(setq!
 ...
 doom-variable-pitch-font (font-spec :family "operator mono" :size 14 :weight 'medium :slant 'italic))
#+END_SRC
...
** Add mixed-pitch-mode to org-mode
:PROPERTIES:
:header-args: :tangle no
:END:

*** Install mixed-pitch-mode
...
Customize mixed-pitch-mode faces. Matches the zen ui module's configuration
...
Enable mixed-pitch-mode on org-mode buffers
...
** Display LSP breadcrumbs automatically
