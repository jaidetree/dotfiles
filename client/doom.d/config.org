...
** TODO [[file:~/org/roam/20201002225634-create_an_org_mode_guide_for_doom_emacs.org][Create an org-mode guide for Doom Emacs]]
** TODO Update config.el to enter into buffer select-mode when creating a split
** TODO Look into [[file:~/org/roam/20201002230128-wrap_text_in_org_mode.org][Wrap text in org-mode]]
* Usage and tips
...
string. You generally only need these two: (setq doom-font (font-spec :family
"monospace" :size 12 :weight 'semi-light) doom-variable-pitch-font (font-spec
:family "sans" :size 13))
...
#+END_SRC
*** Use TAB to cycle through visibility states of current subtree
#+BEGIN_SRC emacs-lisp
(after! evil-org
...
#+END_SRC
*** Update org-roam functions to support creating notes in tag directories
**** Capture
#+BEGIN_SRC emacs-lisp
