...
#+END_SRC
** Install github flavored markdown package for better exports
#+BEGIN_SRC emacs-lisp :tangle packages.el
(package! ox-gfm)
#+END_SRC
...
** Switch buffer when splitting windows
Thanks to tecosaur from https://tecosaur.github.io/emacs-config/config.html#windows
#+BEGIN_SRC emacs-lisp
(defadvice! prompt-for-buffer (&rest _)
  :after '(evil-window-split evil-window-vsplit)
  (call-interactively #'switch-to-buffer))
#+END_SRC
** Clean up org-mode formatting
From https://tecosaur.github.io/emacs-config/config.html#org-mode
*** Unpin package
#+BEGIN_SRC emacs-lisp :tangle packages.el
(unpin! org)
#+END_SRC
*** Configure org-mode superstar
#+BEGIN_SRC emacs-lisp
